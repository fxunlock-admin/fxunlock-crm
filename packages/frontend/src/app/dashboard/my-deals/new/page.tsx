...
const DEAL_TYPES = ['CPA', 'REBATES', 'HYBRID', 'PNL'] as const
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.dealType === 'CPA') {
        ...
        dealData.lotsToQualifyCpa = parseFloat(formData.lotsToQualifyCpa)
          ...
          {formData.dealType === 'CPA' && (
            <Card className="border-t-4 border-t-blue-600">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="lotsToQualifyCpa">Lots to Qualify CPA *</Label>
                  <Input
                    id="lotsToQualifyCpa"
                    type="number"
                    step="0.1"
                    placeholder="e.g., 5.0"
                    value={formData.lotsToQualifyCpa}
                    onChange={(e) => setFormData({ ...formData, lotsToQualifyCpa: e.target.value })}
                    required
                  />
                  <p className="text-xs text-gray-500">Minimum lots a trader must trade to qualify for CPA</p>
                </div>
